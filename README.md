...
When this experimental branch is run directly from PyCharm, `large-v3` is
also selected by default. Install `requirements-nvidia.txt` and run
`python main.py`; no additional model-selection variable is required.
